...
let recName; // Variable to store value of Project Name field

export default class CreateProject extends lightningModal {
  objectApiName = PROJECT_OBJECT;

  // action on click of save button: to craete a new Project record
  async handleSave() {
    try {
      ...
      this.dispatchEvent(
        new ShowToastEvent({
          title: recName + " Project record created",
