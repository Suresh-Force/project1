...
export default class CreateClient extends lightningModal {
  objectApiName = CLIENT_OBJECT;

  // action on click of save button: to craete a new Client record
  async handleSave() {
    try {
      ...
      this.dispatchEvent(
        new ShowToastEvent({
          title: recName + " Client record created",
